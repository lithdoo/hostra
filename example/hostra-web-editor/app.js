...
const lspCli = path.resolve(__dirname, '../../web-components/lsp-ws-server/dist/cli.js');
const webEditorDist = path.resolve(__dirname, '../../web-components/web-editor-component/dist');
